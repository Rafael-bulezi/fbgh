...
export const CATEGORY_CARS: Record<CategoryId, ShowcaseCar[]> = {
  all: [
    ...
    {
      vehicleId: 'jeep-grand-wagoneer-series-iii',
      brand: 'JEEP',
      model: 'GRAND WAGONEER',
      subModel: 'SERIES III',
      mpg: 'UP TO 20 MPG',
      description: 'Pinnacle American luxury with Palermo quilted leather, McIntosh 23-speaker Reference sound, and three rows of first-class comfort for 6 passengers.',
      exteriorPhoto: 'https://res.cloudinary.com/dv9jpkgrs/image/upload/v1789740443/Black_SUV_in_showroom_20260915230340_irhlcp.jpg',
      interiorPhoto: 'https://res.cloudinary.com/dv9jpkgrs/image/upload/v1789740439/SUV_interior_cabin_light_gray_20260915230249_n131sa.jpg',
      thumbImg: 'https://res.cloudinary.com/dv9jpkgrs/image/upload/v1789740443/Black_SUV_in_showroom_20260915230340_irhlcp.jpg',
    },
  ],
  suv: [
    {
