    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full space-y-16 sm:space-y-20 relative z-10">
        ...
        <div className="text-center flex flex-col items-center justify-center footer-shimmer-trigger pt-4 sm:pt-6">
          ...
          {/* Big, Very Big Centered Golden Monogram Crest — Animated flowing stroke */}
          <style>{`
            .footer-logo-track {
              fill: transparent;
              stroke: #E0A852;
            ...
            .footer-logo-stream {
              ...
              animation: footer-logo-flow 2.5s linear infinite;
            }
            @keyframes footer-logo-flow {
