...
export const Logo: React.FC<LogoProps> = ({
  ...
  const animationStyles = `
    ...
    .logo-stream {
      ...
      animation: logo-flow 2.5s linear infinite;
    }
    @keyframes logo-flow {
    ...
    <>
      ...
      >
        ...
        >
          {animate ? (
            <>
              {/* Faint track (full shape always visible) */}
              <path
                d={pathData}
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            /* Static fallback (solid gold fill) */
            <path
              d={pathData}
              fillRule="evenodd"
              clipRule="evenodd"
